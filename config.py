...
class PlayPanelConfig:
    ...
    lyrics_sync_offset_seconds: float = 0.0
    lyrics_bottom_enabled: bool = True
    lyrics_bottom_font_size: str = "clamp(.88rem, 1.35vw, 1.06rem)"
    lyrics_bottom_max_width: str = "920px"
    lyrics_bottom_opacity: float = 0.92
    lyrics_bottom_animation_enabled: bool = True
    lyrics_bottom_animation_duration: int = 520
    lyrics_bottom_animation_distance: int = 10
...
def load_config(path: Path = CONFIG_FILE) -> PlayPanelConfig:
    ...
    return PlayPanelConfig(
        ...
        lyrics_sync_offset_seconds=float(lyrics.get("sync_offset_seconds", defaults.lyrics_sync_offset_seconds)),
        lyrics_bottom_enabled=bool(lyrics.get("bottom_enabled", defaults.lyrics_bottom_enabled)),
        lyrics_bottom_font_size=str(lyrics.get("bottom_font_size", defaults.lyrics_bottom_font_size)),
        lyrics_bottom_max_width=str(lyrics.get("bottom_max_width", defaults.lyrics_bottom_max_width)),
        lyrics_bottom_opacity=float(lyrics.get("bottom_opacity", defaults.lyrics_bottom_opacity)),
        lyrics_bottom_animation_enabled=bool(lyrics.get("bottom_animation_enabled", defaults.lyrics_bottom_animation_enabled)),
        lyrics_bottom_animation_duration=int(lyrics.get("bottom_animation_duration", defaults.lyrics_bottom_animation_duration)),
        lyrics_bottom_animation_distance=int(lyrics.get("bottom_animation_distance", defaults.lyrics_bottom_animation_distance)),
