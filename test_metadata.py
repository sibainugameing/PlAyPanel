...
def main() -> None:
    ...
    print(
        "This is a separate test FIFO; it does not use the real Shairport Sync pipe.",
        flush=True,
    )
    ...
    try:
        ...
        print(
            "No PlayPanel reader is connected to the test FIFO. "
            "Start app.py with PLAYPANEL_METADATA_PIPE set to the same FIFO.",
            flush=True,
        )
        raise SystemExit(1)
